...
export default function DesktopSideNav() {
  ...
  return (
    <nav className="hidden md:flex flex-col w-20 lg:w-56 h-screen sticky top-0 bg-surface-container-lowest border-r border-outline-variant/20 shrink-0 transition-[width] duration-300">
      {/* Logo */}
        ...
        {links.map(({ href, icon, label }) => {
          ...
          return (
            ...
            >
              ...
              <span className="hidden lg:block font-label text-xs uppercase tracking-wider font-medium">{label}</span>
            </Link>
          );
        })}
      </div>
