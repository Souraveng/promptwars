  ...
  return (
    <div className="relative z-10 w-full h-full max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-12 gap-6 pb-12">
        ...
        <div className="col-span-12 lg:col-span-8 flex flex-col gap-6">
          ...
          <div className="bg-surface-container-lowest rounded-xl p-6 shadow-lg border border-outline-variant/10">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4 px-4 py-3 rounded-lg bg-surface-container-low hover:bg-surface-container transition-colors items-center border border-transparent hover:border-outline-variant/10">
                <div className="col-span-1 md:col-span-4">
                  <div className="font-bold text-sm text-inverse-surface font-headline tracking-wide">B-882X</div>
                  <div className="text-xs text-outline truncate">Neon Nights Festival</div>
                </div>
                <div className="col-span-1 md:col-span-3 text-sm text-primary">VIP Deck Alpha</div>
                <div className="col-span-1 md:col-span-2 md:text-right font-headline text-sm">250</div>
                <div className="col-span-1 md:col-span-3 flex md:justify-end">
                  <div className="bg-on-tertiary-container/10 text-on-tertiary-container rounded flex items-center gap-2 px-2 py-1 text-[0.65rem] uppercase tracking-widest font-bold w-max">
                    <span className="w-1.5 h-1.5 rounded-full bg-on-tertiary-container shadow-[0_0_8px_var(--tw-colors-on-tertiary-container)]"></span> Encoding
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4 px-4 py-3 rounded-lg bg-surface-container-low hover:bg-surface-container transition-colors items-center border border-transparent hover:border-outline-variant/10">
                <div className="col-span-1 md:col-span-4">
                  <div className="font-bold text-sm text-inverse-surface font-headline tracking-wide">B-881J</div>
                  <div className="text-xs text-outline truncate">Cyber-Symphony Beta</div>
                </div>
                <div className="col-span-1 md:col-span-3 text-sm text-primary">General Admiss.</div>
                <div className="col-span-1 md:col-span-2 md:text-right font-headline text-sm">12,000</div>
                <div className="col-span-1 md:col-span-3 flex md:justify-end">
                  <div className="bg-secondary/10 text-secondary rounded flex items-center gap-2 px-2 py-1 text-[0.65rem] uppercase tracking-widest font-bold w-max">
                    <span className="w-1.5 h-1.5 rounded-full bg-secondary shadow-[0_0_8px_var(--tw-colors-secondary)]"></span> Ready
                  </div>
        ...
        <div className="col-span-12 lg:col-span-4 max-h-[80vh]">
          <div className="bg-surface-variant/40 backdrop-blur-xl border-t border-l border-outline-variant/20 rounded-2xl p-6 h-fit shadow-xl sticky top-4">
            <div className="flex items-center gap-3 mb-6">
              <span className="material-symbols-outlined text-primary text-2xl" data-icon="qr_code_scanner">qr_code_scanner</span>
              <h2 className="font-headline text-lg font-bold text-primary tracking-tight">Node Generation Toolkit</h2>
            </div>
            ...
            <form className="space-y-5">
              ...
              <div className="group relative">
                ...
                <div className="relative bg-surface-container-lowest rounded-lg p-3 transition-colors duration-200 group-focus-within:bg-surface-container-low border border-outline-variant/20 group-focus-within:border-primary/50">
                  <select className="w-full bg-transparent border-none text-sm text-inverse-surface focus:ring-0 p-0 appearance-none outline-none font-medium cursor-pointer">
                    <option className="bg-surface text-on-surface">Cyber-Symphony Beta</option>
                    <option className="bg-surface text-on-surface">Neon Nights Festival</option>
                  </select>
                  <span className="material-symbols-outlined absolute right-3 top-1/2 -translate-y-1/2 text-outline pointer-events-none text-sm" data-icon="expand_more">expand_more</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="group relative">
                  ...
                  <div className="relative bg-surface-container-lowest rounded-lg p-3 transition-colors duration-200 group-focus-within:bg-surface-container-low border border-outline-variant/20 group-focus-within:border-primary/50">
                    <select className="w-full bg-transparent border-none text-sm text-inverse-surface focus:ring-0 p-0 appearance-none outline-none font-medium cursor-pointer">
                      <option className="bg-surface text-on-surface">Sector 7G</option>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-surface-container-lowest rounded-lg p-3 transition-colors duration-200 group-focus-within:bg-surface-container-low border border-outline-variant/20 group-focus-within:border-primary/50">
                    <select className="w-full bg-transparent border-none text-sm text-inverse-surface focus:ring-0 p-0 appearance-none outline-none font-medium cursor-pointer">
                      ...
                      <option className="bg-surface text-on-surface">East Node</option>
                    </select>
                  </div>
                </div>
              </div>
              ...
              <div className="group relative">
                <label className="text-[0.65rem] uppercase tracking-widest font-bold text-on-surface-variant mb-2 block">Volume (Quantity)</label>
                <div className="relative bg-surface-container-lowest rounded-lg p-3 transition-colors duration-200 group-focus-within:bg-surface-container-low border border-outline-variant/20 group-focus-within:border-primary/50 flex items-center">
                  <input className="w-full bg-transparent border-none font-headline text-lg text-primary focus:ring-0 p-0 outline-none" type="number" defaultValue="1000" />
                  <span className="text-xs text-outline font-label uppercase">Units</span>
                </div>
              </div>
              
              <div className="pt-4 border-t border-surface-container-highest/50">
                <button className="w-full bg-gradient-to-r from-primary to-primary-container text-on-primary font-bold text-sm py-4 px-4 rounded-xl shadow-[0_8px_16px_rgba(6,14,32,0.4)] hover:shadow-[0_12px_24px_rgba(6,14,32,0.6)] hover:contrast-125 transition-all duration-300 flex items-center justify-center gap-2" type="button">
                  <span className="material-symbols-outlined text-[18px]" data-icon="memory" style={{ fontVariationSettings: "'FILL' 1" }}>memory</span>
                  Initialize Generation Matrix
                </button>
                <div className="text-center mt-3 text-[0.65rem] text-outline tracking-wider uppercase font-label">
                  Est. processing time: ~45s
                </div>
              </div>
            </form>
          </div>
