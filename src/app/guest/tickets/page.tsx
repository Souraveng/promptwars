...
export default function GuestTicketPage() {
  ...
  const { tickets, loading: guestLoading, user, activeTicket, setActiveTicket } = useGuest();
            ...
            >
              ...
              <div className="w-full flex justify-between items-start mb-8 z-10">
                <div className="flex-1">
                  ...
                  <h4 className="text-black font-black text-3xl leading-[0.85] tracking-tighter uppercase">{currentTicket.event.title}</h4>
                </div>
              ...
              >
                {isExpired ? (
                  ...
                  <>
                    ...
                    Context Offline (Scheduled)
                  </>
                ) : (
                  <>
                    <span className="material-symbols-outlined text-sm">verified_user</span>
                    Activate for Tactical OS
                  </>
                )}
              </button>
           )}
