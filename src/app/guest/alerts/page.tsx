            ...
            return (
              ...
              >
                ...
                <div className={`absolute -right-10 -top-10 w-40 h-40 rounded-full blur-[80px] opacity-10 transition-transform duration-700 group-hover:scale-150
                  ${isTactical ? 'bg-error' : 'bg-primary'}`}></div>
                ...
                <div className="flex justify-between items-start mb-4 relative z-10">
                  ...
                  <span className="text-[10px] font-mono text-on-surface-variant font-bold bg-white/5 px-2 py-1 rounded-lg border border-white/5">
